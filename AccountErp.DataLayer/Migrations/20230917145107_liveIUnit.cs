...
{
    public partial class liveIUnit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "UserScreenPermissionAccess",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserScreenPermissionAccess", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShopAddress = table.Column<string>(maxLength: 250, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppovedId = table.Column<int>(nullable: false),
                    VatAmount = table.Column<decimal>(nullable: false),
                    SalesOrderNumber = table.Column<string>(nullable: false),
                    CurrencyId = table.Column<int>(nullable: false),
                    ConversionRate = table.Column<double>(nullable: false),
                    TotalAmountAfterConversion = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ProjectName = table.Column<string>(maxLength: 250, nullable: false),
                    CustomerId = table.Column<int>(nullable: false),
                    Status = table.Column<int>(nullable: false),
                    CreatedOn = table.Column<DateTime>(nullable: false),
                    CreatedBy = table.Column<string>(maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Brands = table.Column<string>(nullable: false),
                    Units = table.Column<int>(nullable: false),
                    RateUSD = table.Column<double>(nullable: false),
                    RateAED = table.Column<double>(nullable: false),
                    PartNumber = table.Column<int>(nullable: false),
                    UAN = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermisionDescription = table.Column<string>(nullable: false),
                    Status = table.Column<int>(nullable: false),
                    CreatedOn = table.Column<DateTime>(nullable: false),
                    CreatedBy = table.Column<string>(maxLength: 40, nullable: false),
                    UpdatedOn = table.Column<DateTime>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScreenAccess", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScreenAccess_UserRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "UserRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ScreenAccess_Screen_ScreenId",
                        column: x => x.ScreenId,
                        principalTable: "Screen",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectTransactions_Bills_BillId",
                        column: x => x.BillId,
                        principalTable: "Bills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectTransactions_Invoices_InvoiceId",
                        column: x => x.InvoiceId,
                        principalTable: "Invoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectTransactions_BillId",
                table: "ProjectTransactions",
                column: "BillId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectTransactions_InvoiceId",
                table: "ProjectTransactions",
                column: "InvoiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScreenAccess_RoleId",
                table: "ScreenAccess",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_ScreenAccess_ScreenId",
                table: "ScreenAccess",
                column: "ScreenId");
