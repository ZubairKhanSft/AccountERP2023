                                  ...
                                  where s.Status != Constants.RecordStatus.Deleted
                                       ...
                                       //  || EF.Functions.Like(s.Id.ToString(), "%" + FilterKey + "%")
                                        //  || EF.Functions.Like((s.Brands.ToString() + s.Model.Replace(" ","") + s.Specification.ToString()).ToString(), "%" + FilterKey.Replace(" ","") + "%")
                                            ...
                                            || EF.Functions.Like((s.Brands  + s.Specification).ToString().Replace(" ",""), "%" + FilterKey.Replace(" ","") + "%")
                                            || EF.Functions.Like((s.Brands  + s.Model).ToString().Replace(" ",""), "%" + FilterKey.Replace(" ","") + "%")
                                            || EF.Functions.Like((s.Brands  + s.PartNumber).ToString().Replace(" ",""), "%" + FilterKey.Replace(" ","") + "%")
                                            || EF.Functions.Like((s.Model  + s.Specification).ToString().Replace(" ",""), "%" + FilterKey.Replace(" ","") + "%")
                                            || EF.Functions.Like((s.Model + s.PartNumber).ToString().Replace(" ", ""), "%" + FilterKey.Replace(" ", "") + "%")

                                            || EF.Functions.Like(s.Specification.ToString(), "%" + FilterKey + "%")
                                            || EF.Functions.Like(s.Brands.ToString(), "%" + FilterKey + "%")
                                            || EF.Functions.Like(s.UPC.ToString(), "%" + FilterKey + "%")
