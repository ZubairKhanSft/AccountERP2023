...
namespace AccountErp.DataLayer.Repositories
{
 ...
 public async Task<JqDataTableResponse<BillListItemDto>> getTopFiveBillsAsync(BillJqDataTableRequestModel model)
        ...
        public async Task<IEnumerable<BillServiceDto>> GetBillItemById(int billId)
        {
          return  await (from s in _dataContext.BillItems
                   where s.BillId == billId
                   select new BillServiceDto
                   {
                      // Id = s.Id,
                       Rate = s.Rate,
                      
                       Price = s.Price,
                       Name = s.Product.Model,
                       TaxId = s.TaxId,
                       ...
                       // BankAccountId = x.Item.BankAccountId,
                       TaxBankAccountId = s.Taxes.BankAccountId,
                       ProductId = s.ProductId,
                       ProductBrand = s.Product.Brands,
                       ProductSpecification = s.Product.Specification,
                              ...
                              //   join u in _dataContext.BillItems on b.Id equals u.BillId
                               ...
                               && (b.BillDate == BillDate || BillDate == null)
                                ...
                                && (FilterKey == null
                                 ...
                                 //    || EF.Functions.Like(u.Quantity.ToString(), "%" + FilterKey + "%"))
                                  select new BillDetailDto
                              {
                                  Id = b.Id,
