...
namespace AccountErp.DataLayer
{
    public class DataContext : IdentityDbContext<AppUser>
    {
        ...
        public DbSet<UserScreenPermissionAccess> UserScreenPermissionAccess { get; set; }
        public DbSet<ScreenAccess> ScreenAccesses { get; set; }
        public DbSet<CurrencyCr> CurrencyCr { get; set; }
        public DbSet<ShippingMethod> ShippingMethods { get; set; }
        public DbSet<InvoiceShippingAddress> InvoiceShippingAddresses { get; set; }
        public DbSet<InvoiceServiceTag> InvoiceServiceTag { get; set; }
        public DbSet<InvoiceTag> InvoiceTag { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new UserScreenPermissionAccessConfiguration());
            modelBuilder.ApplyConfiguration(new ScreenAccessConfiguration());
            modelBuilder.ApplyConfiguration(new CurrencyCrConfiguration());


            modelBuilder.ApplyConfiguration(new ShippingMethodConfiguration());
            modelBuilder.ApplyConfiguration(new InvoiceShippingAddressConfiguration());
            modelBuilder.ApplyConfiguration(new InvoiceServiceTagConfiguration());
            modelBuilder.ApplyConfiguration(new InvoiceTagConfiguration());
